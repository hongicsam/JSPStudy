...
<body>
	...
	<!-- 이클립스에서는 우리가 직접 작성한 파일을 실행하지 않고 .metadata 디렉토리 하위에 프로젝트와 동일한 톰캣 환경을 만들어서 복사본 파일을 실행하게된다.
	...
	<%!
	/* 선언부에서는 내장객체를 바로 사용하는것은 불가능하다.
	내장객체는 _jspService() 메서드 내에서 생성된 지역변수이므로 다른 지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다. */
